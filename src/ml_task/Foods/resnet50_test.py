...
'''
train_parameters = {
    "version": "net3resnet50_pretrained",
...
mynet = paddle.vision.models.resnet50(num_classes=5)
...
# module.prepare(optimizer, loss_fn, Accuracy())
# callback = paddle.callbacks.VisualDL(log_dir=log_dir)
# module.fit(train_set, eval_set, epochs=epochs, batch_size=batch_size, log_freq=1000, save_dir=save_dir,
#           callbacks=callback)
